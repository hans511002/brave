...
#include "Training_92.h"   
#include "engine/World.h"   
#include "engine/CallDelay.h" 
using namespace engine;

namespace training
{
	Training_92_mc::Training_92_mc() :MovieClip("training", "Training_92_mc", "Training_92_mc")
	{
	...
	Training_92::Training_92(int param1) :viewCounter(15), page(0), type(0)
	{
	...
	bool Training_92::init()
	{
		...
		this->container = new Training_92_mc();
		this->container->setPosition(Main::SCREEN_WIDTH_HALF, Main::LEVEL_MAP_HEIGHT/2);
		this->contStops();
	...
	void Training_92::enterFrameHandler(float dt)
	{
	...
	void Training_92::mouseMoveHandler(cocos2d::EventMouse * e)
	{
	...
	void Training_92::mouseDownHandler(cocos2d::EventMouse * e)
	{
	...
	void Training_92::mouseUpHandler(cocos2d::EventMouse * e)
	{
	...
	void Training_92::kill()
	{
		if (!this->dead)
		{
			...
			if (this->type == 12)
			{
				AnimUpgrade_mc  * anim= new AnimUpgrade_mc(); 
				Vec2 pos = this->world->worldInterface->container->stoneSphere->convertToWorldSpace(Vec2(0, 0));
				pos = this->world->worldInterface->convertToNodeSpaceAR(Vec2(0, 0));
				anim->setPosition(pos);
				anim->mouseChildren = false;
				anim->mouseEnabled = false;
				this->world->worldInterface->addChild(anim);
				this->world->worldInterface->listOfAnimation.push(anim);
