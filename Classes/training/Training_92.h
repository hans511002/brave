#ifndef TRAINING_TRAINING_92_H
#define TRAINING_TRAINING_92_H
...
namespace training
{
	struct Training_92_mc : public MovieClip {
		Training_92_mc();
		MovieClipSub * cont;
	...
	class Training_92 :public Training
	{
	public:

		Training_92_mc * container;
		int type;
		int page;
		int viewCounter;

		Training_92(int param1);
