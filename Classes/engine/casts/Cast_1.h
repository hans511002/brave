package engine.casts
{
    ...
    public class Cast_1 extends Cast
    {

        public function Cast_1()
        {
            return;
        }// end function
                        ...
                        if (map[i].y >= map[(i - 1)].y)
                        {
                            ...
                            while (j < map[i].y)
                            {
                                ...
                                if (tempObject2 < 30)
                                {
                                    ...
                                    {
                                        tempObject1 = new Golem(new Point(map[i].x, j), n, i);
                        ...
                        if (map[i].x >= map[(i - 1)].x)
                        {
                            ...
                            while (j < map[i].x)
                            {
                                ...
                                if (tempObject2 < 30)
                                {
                                    ...
                                    {
                                        tempObject1 = new Golem(new Point(j, map[i].y), n, i);
                                        world.addChild(tempObject1);
                                        return;
                                    }
                                }
