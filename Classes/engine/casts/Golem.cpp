...
namespace engine {
	namespace casts
	{
		...
		Golem::Golem(cocos2d::Point param1, int param2, int param3, bool param4) : world(NULL), direction("none"), movePhase(1), speedK(0), speedKSave(0), radius(0), road(0), roadMap(0), dead(false), health(0), healthSave(0), openFlag(false), voiceCounter(10), brother(NULL), cameraJitterTimer(3), cameraJitterCounter(0), cameraXOffset(0), cameraYOffset(0)
		{
			SET_NODETYPENAME();
		...
		void  Golem::update(float dt)
		{
			...
			if (!this->openFlag)
			{
				...
				{
					if (this->cameraJitterCounter == 0)//��ԭ�ƶ�ǰλ��
					{
