	...
	{   
		...
		void Unit_20::kill()
        {
            if (!dead && health <= 0)
            {
                ...
                //cocos2d::Point path1 = container->localToGlobal(container->getPosition());//new Point(container->x, container->y));
                ...
                { 
                    ...
                    {
                        path1 = path1 + 15;
                        tempObject = world->addUnit(31, road, 1, path1);
                        tempObject->speedKSave = tempObject->speedKSave - 0.1;
                    }
                    else if (j == 2)
                    {
                        path2 = path2 + 15;
                        tempObject = world->addUnit(31, road, 2, path2);
                    ...
                    else if (j == 3)
                    {
                        j = 0;
                        path3 = path3 + 15;
                        tempObject = world->addUnit(31, road, 3, path3);
