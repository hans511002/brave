...
namespace engine {
    ...
    GetSphere::GetSphere(string param1) : container(NULL), radius(NULL), counter(0), owner(NULL),
                                          myRadius(0), myDamage(0), fireCount(0), iceCount(0),
                                          stoneCount(0), levinCount(0), getAllCount(0), world(NULL),
                                          dead(0), speedFrame(0), speedY(0), arrow(NULL),
                                          towerArrow(NULL), containerChange(NULL) {
        //this->listOfStack = [];
        ...
        if (this->type == "holder") {
            if (dynamic_cast<GetSphere_mc *>(this->container)) {
                ...
                if (container->sphere1->isVisible()) {
                    if (container->sphere1Cont->currentFrame <
                        container->sphere1Cont->totalFrames) {
                        container->sphere1Cont->tryPlay();
                ...
                if (container->sphere2->isVisible()) {
                    if (container->sphere2Cont->currentFrame <
                        container->sphere2Cont->totalFrames) {
                        container->sphere2Cont->tryPlay();
                ...
                if (container->sphere3->isVisible()) {
                    if (container->sphere3Cont->currentFrame <
                        container->sphere3Cont->totalFrames) {
                        container->sphere3Cont->tryPlay();
                ...
                if (container->sphere4->isVisible()) {
                    if (container->sphere4Cont->currentFrame <
                        container->sphere4Cont->totalFrames) {
                        container->sphere4Cont->tryPlay();
    ...
    void GetSphere::mouseMoveHandler(cocos2d::Event *e) {
        ...
        if (targetName == "fireCase") {
            if (ISTYPE(EventNode, event->target)->mouseEnabled &&
                this->world->worldInterface->container->fireBack->currentFrame == 1) {
        ...
        if (targetName == "iceCase") {
            if (ISTYPE(EventNode, event->target)->mouseEnabled &&
                this->world->worldInterface->container->iceBack->currentFrame == 1) {
        ...
        if (targetName == "stoneCase") {
            if (ISTYPE(EventNode, event->target)->mouseEnabled &&
                this->world->worldInterface->container->stoneBack->currentFrame == 1) {
                if (this->world->worldInterface->container->fireBack->currentFrame == 2) {
                    this->world->worldInterface->container->fireBack->gotoAndStop(1);
                }
                if (this->world->worldInterface->container->iceBack->currentFrame == 2) {
        ...
        if (targetName == "levinCase") {
            if (ISTYPE(EventNode, event->target)->mouseEnabled &&
                this->world->worldInterface->container->levinBack->currentFrame == 1) {
                if (this->world->worldInterface->container->fireBack->currentFrame == 2) {
                    this->world->worldInterface->container->fireBack->gotoAndStop(1);
                }
                if (this->world->worldInterface->container->iceBack->currentFrame == 2) {
        ...
        if (targetName == "getAllCase") {
            if (ISTYPE(EventNode, event->target)->mouseEnabled &&
                this->world->worldInterface->container->getAll->currentFrame == 1) {
                if (this->world->worldInterface->container->fireBack->currentFrame == 2) {
                    this->world->worldInterface->container->fireBack->gotoAndStop(1);
                }
                if (this->world->worldInterface->container->iceBack->currentFrame == 2) {
        ...
        if (targetName == "fireCase" || targetName == "iceCase" || targetName == "stoneCase"
            || targetName == "levinCase" || targetName == "getAllCase" ||
            targetName == "archiveCase"
            || targetName == "interfaceUpCase" || targetName == "sellCase" ||
            targetName == "towerCase") {
            if (this->radius->isVisible()) {
    ...
    void GetSphere::mouseDownHandler(cocos2d::Event *e) {
        ...
        if (targetName == "sellCase") {
            ...
            this->kill();
            AudioUtil::playSound("Snd_world_sell.mp3");
            ...
            MovieClip *sphereAnima = sphereSlot->getMem<MovieClip>(
                    "sphereAnima");// towerMenuMc->getSphereAnima(scase);
        ...
        if (param1 == "add") {
            if (this->type == "holder") {
                ...
                if (this->listOfStack.size() < 4) {
                    ...
                    if (this->fireCount == 1 && this->iceCount == 1 && this->stoneCount == 1 &&
                        this->levinCount == 1) {
                        this->fireCount = 0;
                        this->iceCount = 0;
                        this->stoneCount = 0;
            ...
            if (this->fireCount > 0 && this->iceCount == 0 && this->stoneCount == 0 &&
                ...
                if (!this->radius) {
                    ...
                    this->arrow->setAlpha(1);
                    this->radius->cont->stop();
                    this->radius->setHeight(
                            Main::mainClass->readXMLClass.listOfMoveStoneXML[0] * 2);
                ...
                if (!this->radius) {
                    ...
                    this->radius->cont->stop();
                    this->radius->setHeight(
                            Main::mainClass->readXMLClass.listOfMoveLevinXML[0] * 2);
                ...
                if (this->type == "holder") {
                    if (this->fireCount > 0) {
                        ...
                        this->myDamage = this->myDamage +
                                         Main::mainClass->readXMLClass.listOfMoveFireXML[this->fireCount];
                    }
                    if (this->iceCount > 0) {
                        ...
                        this->myDamage = this->myDamage +
                                         Main::mainClass->readXMLClass.listOfMoveIceXML[this->iceCount];
                    }
                    if (this->stoneCount > 0) {
                        ...
                        this->myDamage = this->myDamage +
                                         Main::mainClass->readXMLClass.listOfMoveStoneXML[this->stoneCount];
                    }
                    if (this->levinCount > 0) {
                        ...
                        this->myDamage = this->myDamage +
                                         Main::mainClass->readXMLClass.listOfMoveLevinXML[this->levinCount];
                    }
                } else if (this->type == "getAll") {
                    if (this->myRadius < Main::mainClass->readXMLClass.listOfMoveFireXML[0]) {
                        this->myRadius = Main::mainClass->readXMLClass.listOfMoveFireXML[0];
    ...
    void GetSphere::retrieveGetSphere() {
        ...
        if (this->ownerType == "archive") {
            AudioUtil::playSoundWithVol("Snd_world_sphereGoToArchive.mp3", 0.9f);
        } else {
            AudioUtil::playSound("Snd_world_sphereMoveBack.mp3");
        }
        bool del = false;
        if (this->fireCount == 0 && this->iceCount == 0 && this->stoneCount == 0 &&
            this->levinCount == 0 && this->getAllCount == 0) {
            del = true;
        } else {
    ...
    void GetSphere::getSphereFromArchiveToTower() {
        if (this->world->towerMenu) {
            ...
            this->ownerPoint = cocos2d::Point(this->world->towerMenu->myTower->getPositionX(),
                                              this->world->towerMenu->myTower->getPositionY() +
                                              this->world->towerMenu->myTower->correctYGrPos);
        } else if (this->world->ultraTowerMenu) {
            this->owner = this->world->ultraTowerMenu->myTower;
            this->ownerPoint = cocos2d::Point(this->world->ultraTowerMenu->myTower->getPositionX(),
                                              this->world->ultraTowerMenu->myTower->getPositionY() +
                                              this->world->ultraTowerMenu->myTower->correctYGrPos);
        }
    ...
    void GetSphere::monitor() {
        if (this->listOfStack.size() < 4 && this->getAllCount == 0) {
            if (this->world->worldInterface->fireCount > 0 || this->world->money >= std::getInt(
                    this->world->worldInterface->container->buyFireBuyTXT) &&
                                                              this->world->worldInterface->container->fireSphere->isVisible()) {
            ...
            if (this->world->worldInterface->iceCount > 0 || this->world->money >= std::getInt(
                    this->world->worldInterface->container->buyIceBuyTXT) &&
                                                             this->world->worldInterface->container->iceSphere->isVisible()) {
            ...
            if (this->world->worldInterface->stoneCount > 0 || this->world->money >= std::getInt(
                    this->world->worldInterface->container->buyStoneBuyTXT) &&
                                                               this->world->worldInterface->container->stoneSphere->isVisible()) {
            ...
            if (this->world->worldInterface->levinCount > 0 || this->world->money >= std::getInt(
                    this->world->worldInterface->container->buyLevinBuyTXT) &&
                                                               this->world->worldInterface->container->levinSphere->isVisible()) {
