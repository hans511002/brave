...
namespace engine
{
    ...
    public:
        ...
        //public var containerChange:MovieClip;
            ...
            GetSphere(string param1= "holder") :counter(0), myRadius(0), myDamage(0), fireCount(0), iceCount(0), stoneCount(0), levinCount(0)
        {
            //this->listOfStack = [];
        ...
        void manage(param1:String, param2 : String = "") 
        {
            if (param1 == "add")
            {
                if (this->type == "holder")
