...
{ 
	...
	void World::mouseMoveHandler(cocos2d::EventMouse* param1){
		...
		//			{
		//				if (!this->towerRadius.visible || param1.target.parent.parent != this->towerRadius.myTower)
		//				{
		...
		//				}
		//			}
		//			else if (this->towerRadius.visible)
		//			{
		...
		//						{
		//							this->towerRadius.myTower.container.selectTower.visible = false;
		//						}
		//					}
		//				}
		//				this->towerRadius.myTower = param1.target.parent.parent;
	...
	void World::rightMouseDownHandler(cocos2d::EventMouse* event){
		...
		//			{
		//				this->i = 0;
		//				while (this->i < this->listOfTowers.length)
		//				{
		...
		//	{
		//		if (!Main.mainClass.saveBoxClass.gameSave.data.firstRC)
		//		{
		//			Main.mainClass.saveBoxClass.gameSave.data.firstRC = true;
	...
	void World::manageIndexes(){
		...
		//		}
		//		if (this->listOfIndexes0.length > 0)
		//		{
		//			this->listOfIndexes0.sortOn(["y", "x"], [Array.NUMERIC, Array.NUMERIC]);
		//			this->m = 0;
		//			while (this->m < this->listOfIndexes0.length)
		//			{ 
		...
		//		this->m = 0;
		//		while (this->m < this->sortIndex.length)
		//		{ 
		//			this->setChildIndex(this->sortIndex[this->m], (this->numChildren - 1));
		//			m++;
		//		}
		//		if (this->listOfIndexes2.length > 0)
		//		{
		//			this->sortIndex = [];
		//			this->sortIndex = this->sortIndex.concat(this->listOfTowers);
		//			this->sortIndex = this->sortIndex.concat(this->listOfIndexes2);
		...
		//				{
		//					this->indexesTemp3 = false;
		//					if (this->sortIndex[this->m] is Bullet)
		//					{
		//						this->n = 0;
		//						while (this->n < this->listOfTowers.length)
		//						{
		//							if (this->listOfTowers[this->n].y > this->sortIndex[this->m].enemyTarget.y)
		//							{
		//								this->indexesTemp3 = true;
		...
		//							{
		//								this->indexesTemp3 = true;
		//								this->tempObject4 = false;
		//								this->n = 0;
		//								while (this->n < this->listOfTowers.length)
		//								{ 
		//									this->tempObject5 = 0;
		//									if (this->sortIndex[this->m].container.haze1.visible && this->listOfTowers[this->n].y > this->sortIndex[this->m].container.haze1.myPoint.y + 30)
		//									{
		//										(this->tempObject5 + 1);
		//									}
		//									if (this->sortIndex[this->m].container.haze2.visible && this->listOfTowers[this->n].y > this->sortIndex[this->m].container.haze2.myPoint.y + 30)
		//									{
		//										(this->tempObject5 + 1);
		//									}
		//									if (this->sortIndex[this->m].container.haze3.visible && this->listOfTowers[this->n].y > this->sortIndex[this->m].container.haze3.myPoint.y + 30)
		//									{
		//										(this->tempObject5 + 1);
		//									}
		//									if (this->sortIndex[this->m].container.haze4.visible && this->listOfTowers[this->n].y > this->sortIndex[this->m].container.haze4.myPoint.y + 30)
		//									{
		//										(this->tempObject5 + 1);
		//									}
		//									if (this->sortIndex[this->m].container.haze5.visible && this->listOfTowers[this->n].y > this->sortIndex[this->m].container.haze5.myPoint.y + 30)
		//									{
		//										(this->tempObject5 + 1);
		//									}
		//									if (this->sortIndex[this->m].container.haze6.visible && this->listOfTowers[this->n].y > this->sortIndex[this->m].container.haze6.myPoint.y + 30)
		//									{
		//										(this->tempObject5 + 1);
		//									}
		//									if (this->sortIndex[this->m].container.haze7.visible && this->listOfTowers[this->n].y > this->sortIndex[this->m].container.haze7.myPoint.y + 30)
		//									{
		//										(this->tempObject5 + 1);
		//									}
		//									if (this->sortIndex[this->m].container.haze8.visible && this->listOfTowers[this->n].y > this->sortIndex[this->m].container.haze8.myPoint.y + 30)
		//									{
		//										(this->tempObject5 + 1);
		//									}
		//									if (this->sortIndex[this->m].container.haze9.visible && this->listOfTowers[this->n].y > this->sortIndex[this->m].container.haze9.myPoint.y + 30)
		//									{
		//										(this->tempObject5 + 1);
		//									}
		//									if (this->tempObject5 >= 3)
		//									{
		//										this->tempObject4 = true;
		//										this->setChildIndex(this->sortIndex[this->m], (this->getChildIndex(this->listOfTowers[this->n]) - 1));
		//										break;
		//									}
		//									var _loc_1 : *= this;
		...
		//							while (this->n < this->listOfTowers.length)
		//							{
		//								if (this->listOfTowers[this->n].y > this->sortIndex[this->m].y)
		//								{
		//									this->indexesTemp3 = true;
		//									this->setChildIndex(this->sortIndex[this->m], (this->getChildIndex(this->listOfTowers[this->n]) - 1));
		//									break;
		...
		//	}
		//	if (this->towerRadius.visible)
		//	{
		//		this->setChildIndex(this->towerRadius, (this->numChildren - 1));
		//	}
		//	if (this->listOfIndexes3.length > 0)
		//	{
		//		this->m = 0;
		//		while (this->m < this->listOfIndexes3.length)
		//		{
		...
		//	}
		//	this->m = 0;
		//	while (this->m < this->listOfMoveSpheres.length)
		//	{
	...
	void World::achieveManage(string param1)
	{
		//if (param1 == "firstKill")
		//{
		//	if (!this->saveBox.gameSave.data.achieve_firstKill)
		//	{
		//		this->saveBox.gameSave.data.achieve_firstKill = true;
		...
		//{
		//	if (!this->saveBox.gameSave.data.achieve_kill_100_enemies)
		//	{
		//		this->saveBox.gameSave.data.achieve_kill_100_enemies = true;
		//		this->worldInterface.addGetAchieve(param1);
		//		if (Main.mainClass.IDIClass.idnet)
		//		{
		//			if (Main.mainClass.IDIClass.idnet.userData)
		...
		//{
		//	if (!this->saveBox.gameSave.data.achieve_kill_2500_enemies)
		//	{
		//		this->saveBox.gameSave.data.achieve_kill_2500_enemies = true;
		//		this->worldInterface.addGetAchieve(param1);
		//		if (Main.mainClass.IDIClass.idnet)
		//		{
		//			if (Main.mainClass.IDIClass.idnet.userData)
		...
		//{
		//	if (!this->saveBox.gameSave.data.achieve_call_100_earlyWaves)
		//	{
		//		this->saveBox.gameSave.data.achieve_call_100_earlyWaves = true;
		//		this->worldInterface.addGetAchieve(param1);
		//		if (Main.mainClass.IDIClass.idnet)
		//		{
		//			if (Main.mainClass.IDIClass.idnet.userData)
		...
		//{
		//	if (!this->saveBox.gameSave.data.achieve_build_100_towers)
		//	{
		//		this->saveBox.gameSave.data.achieve_build_100_towers = true;
		//		this->worldInterface.addGetAchieve(param1);
		//		if (Main.mainClass.IDIClass.idnet)
		//		{
		//			if (Main.mainClass.IDIClass.idnet.userData)
		...
		//{
		//	if (!this->saveBox.gameSave.data.achieve_createGolem_5_times)
		//	{
		//		this->saveBox.gameSave.data.achieve_createGolem_5_times = true;
		//		this->worldInterface.addGetAchieve(param1);
		//		if (Main.mainClass.IDIClass.idnet)
		//		{
		//			if (Main.mainClass.IDIClass.idnet.userData)
