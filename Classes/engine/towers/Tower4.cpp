...
namespace engine
{
	namespace towers
	{
		...
		bool Tower4_mc::init() {
			...
			sphere4_1Bullet->setPosition(sphere4_1Bullet->getPosition() + Vec2(0, -15));
			sphere4_2Bullet->setPosition(sphere4_2Bullet->getPosition() + Vec2(0, -15));
			sphere4_3Bullet->setPosition(sphere4_3Bullet->getPosition() + Vec2(0, -15));
			sphere4_4Bullet->setPosition(sphere4_4Bullet->getPosition() + Vec2(0, -15));
			return true;
		}
   ...
   //         }
			...
			{
				container->sphere2_1->tryPlay(0);
				container->sphere2_1BulletCont->tryPlay(0);
				...
				//} 
				container->sphere2_2->tryPlay(0);
				container->sphere2_2BulletCont->tryPlay(0);
			...
			{
				container->sphere3_1->tryPlay(0);
				container->sphere3_1BulletCont->tryPlay(0);
				...
				//} 
				container->sphere3_2->tryPlay(0);
				container->sphere3_2BulletCont->tryPlay(0);
				...
				//} 
				container->sphere3_3->tryPlay(0);
				container->sphere3_3BulletCont->tryPlay(0);
			...
			{
				container->sphere4_1->tryPlay(0);
				container->sphere4_1BulletCont->tryPlay(0);
				...
				//} 
				container->sphere4_2->tryPlay(0);
				container->sphere4_2BulletCont->tryPlay(0);
				...
				//} 
				container->sphere4_3->tryPlay(0);
				container->sphere4_3BulletCont->tryPlay(0);
				...
				//} 
				container->sphere4_4->tryPlay(0);
				container->sphere4_4BulletCont->tryPlay(0);
