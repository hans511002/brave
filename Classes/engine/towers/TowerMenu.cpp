...
namespace engine
{
    namespace towers
    {
            ...
            if (!this->closeFlag)
            {
                ...
                else
                {
                    ...
                    if (this->container->sphereSlot1->isVisible())
                    {
                        ...
                        //{
                        //    if (this->container->sphereSlot1.fire.currentFrame < this->container->sphereSlot1.sphereAnima.fire.totalFrames)
                        //    {
        ...
        void TowerMenu::mouseMoveHandler(cocos2d::Event * param1)
        {
            ...
            //            if (param1.target.parent.name == "btnTowerUpgr1")
            //            {
            //                if (this->world->worldInterface->container.iceBacklight.visible || this->world->worldInterface->container.levinBacklight->isVisible())
            //                {
            ...
            //            else if (param1.target.parent.name == "btnTowerUpgr2")
            //            {
            //                if (this->world->worldInterface->container.fireBacklight.visible || this->world->worldInterface->container.stoneBacklight->isVisible())
            //                {
            //                    this->world->worldInterface->archiveSphereBacklightManage("");
            //                }
            ...
            //            else if (param1.target.parent.name == "btnTowerUpgr3")
            //            {
            //                if (this->world->worldInterface->container.fireBacklight.visible || this->world->worldInterface->container.levinBacklight->isVisible())
            //                {
            //                    this->world->worldInterface->archiveSphereBacklightManage("");
            //                }
            //                if (!this->world->worldInterface->container.iceBacklight->isVisible())
            ...
            //            else if (param1.target.parent.name == "btnTowerUpgr4")
            //            {
            //                if (this->world->worldInterface->container.iceBacklight.visible || this->world->worldInterface->container.stoneBacklight->isVisible())
            //                {
            //                    this->world->worldInterface->archiveSphereBacklightManage("");
            //                }
            //                if (!this->world->worldInterface->container.fireBacklight->isVisible())
            ...
            //        else
            //        {
            //            if (this->world->worldInterface->container.fireBacklight.visible || this->world->worldInterface->container.iceBacklight.visible || this->world->worldInterface->container.stoneBacklight.visible || this->world->worldInterface->container.levinBacklight->isVisible())
            //            {
            //                this->world->worldInterface->archiveSphereBacklightManage("");
            //            }
