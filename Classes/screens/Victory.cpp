...
namespace screens
{
    WinMenuBase::WinMenuBase(const string & name):MovieCLip("screen",name,"WinMenu_mc")
    {
        ...
        this->firstScrollBtnContinue=this->firstStars->createMovieCLipSub("btnContinue");
        ...
        this->firstScrollBtnRestart=this->firstStars->createMovieCLipSub("btnRestart");
        ...
        this->firstScrollBtnContinue=this->firstStars->createMovieCLipSub("continue");
    ...
    WinMenuFinish_mc::WinMenuFinish_mc():WinMenuBase("WinMenuFinish_mc")
    {
        ...
        this->firstSponsorLink1=this->firstSponsor->createMovieCLipSub<SponsorLink>("link1");
        this->firstSponsorLink2=this->firstSponsor->createMovieCLipSub<SponsorLink>("link2");
        this->firstSponsorLink3=this->firstSponsor->createMovieCLipSub<SponsorLink>("link3");
    ...
    void Victory::enterFrameHandler(float dt) 
    {
        ...
        if (this->openFlag)
        {
            ...
            else
            {
                ...
                cocos2d::Point tempObject = new Point(Main::mouseX, Main::mouseY);
                ...
                if (this->container->firstSponsor->currentFrame < this->container->firstSponsor->totalFrames)
                {
                    ...
                    if (this->container->firstSponsorLink1)
                    {
                        if (!this->container->firstSponsorLink1Link1Case->mouseEnabled)
                        {
                            ...
                            this->container->firstSponsorLink1Cont->stop();
                            this->container->firstSponsorLink1Link1Case->stop();
                ...
                if (this->container->firstScrollBtnContinue->currentFrame == 3)
                {
                    ...
                    if (this->container->firstSponsor)
                    {
                        if (this->container->firstSponsorLink1)
                        {
                            ...
                            this->container->firstSponsor->removeChild(this->container->firstSponsorLink1);
                            this->container->firstSponsorLink1 = NULL;
                        }
                        if (this->container->firstSponsorLink2)
                        {
                            this->container->firstSponsor->removeChild(this->container->firstSponsorLink2);
                            this->container->firstSponsorLink2 = NULL;
                        }
                        if (this->container->firstSponsorLink3)
                        {
                            this->container->firstSponsor->removeChild(this->container->firstSponsorLink3);
                            this->container->firstSponsorLink3 = NULL;
                        }
                    }
    ...
    void Victory::link1Play(event:VideoEvent) 
    {
        if (this->container->firstSponsor)
        {
    ...
    void Victory::link2Play(event:VideoEvent) 
    {
        if (this->container->firstSponsor)
        {
    ...
    void Victory::link3Play(event:VideoEvent) 
    {
        if (this->container->firstSponsor)
        {
    ...
    void Victory::reInit(event:Event) 
    {
