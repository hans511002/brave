...
{  
    ...
    { 
		...
		game2NewGame2Case = game2->createCase("newGame2Case", true);
		game2SyncSlot = game2->createMovieClipSub("syncSlot", true);
		game2SyncSlotSyncSlotCase = game2SyncSlot->createCase("syncSlotCase", true);
		...
		game3NewGame3Case = game3->createCase("newGame3Case", true);
